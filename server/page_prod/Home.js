...
/***/ function(module, exports, __webpack_require__) {
	...
	var _appHome = __webpack_require__(149);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ChangeEventPlugin = __webpack_require__(27);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ExecutionEnvironment = __webpack_require__(18);
	var FallbackCompositionState = __webpack_require__(19);
	var SyntheticCompositionEvent = __webpack_require__(23);
	var SyntheticInputEvent = __webpack_require__(25);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getTextContentAccessor = __webpack_require__(22);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isTextInputElement = __webpack_require__(37);
	var keyOf = __webpack_require__(26);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _HomeCss = __webpack_require__(150);
	...
	var Home = (function (_Component) {
	  ...
	  function Home() {
	    ...
	    this.addTodo = function (event) {
	      event.preventDefault();
	      var value = _this.refs.text.value;
	    ...
	    this.deleteTodo = function (event, id) {
	      event.preventDefault();
	    ...
	    this.updateTodo = function (event, id, text) {
	      event.preventDefault();

	      var newText = window.prompt('input a new text', text);
	    ...
	    value: function render() {
	            ...
	            _react2['default'].createElement(
	              'a',
	              {
	                ...
	                onClick: function (event) {
	                  return _this3.updateTodo(event, todo.id, todo.text);
	                } },
	              '更新'
	            ),
	            _react2['default'].createElement(
	              ...
	              {
	                href: '',
	                className: _HomeCss2['default'].linkDel,
	                onClick: function (event) {
	                  return _this3.deleteTodo(event, todo.id);
	                } },
	              '删除'
	            )
	          )
	      ...
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          'table',
	          {
	            className: _HomeCss2['default'].table,
	            cellSpacing: '1',
	            cellPadding: '1' },
	          _react2['default'].createElement(
	            'thead',
...
/***/ function(module, exports) {
	...
	module.exports = {
		...
		"bg": "Home__bg___3txWj",
		"table": "Home__table___31tZ2",
		"linkDel": "Home__linkDel___2tLyD"
	};
	    ...
	    value: function render() {
	      ...
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          ...
	          _react2['default'].createElement('script', { src: '/dpd.js' }),
